...
export const TextButton = ({ children, onPress, style }) => (
    <Button onPress={onPress} style={{width:200,marginBottom:10, backgroundColor:'blue',justifyContent:'center'}} >
  ...
  export const HomeButton = ({ children, onPress, style }) => (
    <Button onPress={onPress} style={{width:200,marginBottom:10, backgroundColor:'yellow',justifyContent:'center'}} >
